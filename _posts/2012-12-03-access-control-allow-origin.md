...
它定义了该资源允许被哪个域引用，或者被所有域引用（google字体使用*表示字体资源允许被所有域引用）。<!--more-->
<h2>什么是资源跨域权限</h2>
<div>
...
但是HTML与字体是跨域！
<div>高级浏览器访问html页面的时候，对于CSS文件中使用的字体文件的请求，会带一个origin:头，这个头就是html页面所在的域。</div>
<div><a href="http://yuguo.us/weblog/files/2012/12/1.png"><img class="aligncenter size-full wp-image-1511" title="1" src="http://yuguo.us/weblog/files/2012/12/1.png" alt="" width="487" height="201" /></a></div>
<div>
